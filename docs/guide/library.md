...
Toggle between different layouts using the toolbar buttons:

- **Grid View** — Card layout with mod icons
...
| **Content Type** | All, Mods, Resource Packs, Shaders |
| **Modpack** | All, Any modpack, No modpack, or specific modpack |
| **Folder** | Filter by your folder organization |
...
1. Click the **CurseForge** button in the toolbar
2. Search for mods
...
1. Click the **Check Updates** button
