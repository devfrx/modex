...
export type ModpackChangeType = "add" | "remove" | "update" | "enable" | "disable" | "version_control" | "loader_change" | "lock" | "unlock" | "note_add" | "note_remove" | "note_change";
 ...
 */
export declare function cfContentTypeToInternal(cfType: CurseForgeContentType): ModContentType;
/**
 * Convert internal content type to CurseForge content type
 */
export declare function internalToCfContentType(internalType: ModContentType): CurseForgeContentType;
