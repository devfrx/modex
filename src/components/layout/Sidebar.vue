  ...
  <div
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-auto">
      <RouterLink to="/home"
        ...
        active-class="bg-primary/10 text-primary border-primary/20 shadow-sm" :class="[
          'text-muted-foreground hover:bg-accent/50 hover:text-foreground',
        ]" @click="handleNavClick">
        <Home class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
      ...
      <RouterLink to="/library"
        ...
        <Library class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
        <span class="flex-1">Library</span>
        <span v-if="modCount > 0"
      ...
      <RouterLink to="/modpacks"
        ...
        <Package class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
        <span class="flex-1">Modpacks</span>
        <span v-if="modpackCount > 0"
          class="text-[10px] bg-background/50 border border-border/50 px-2 py-0.5 rounded-full font-mono transition-colors group-hover:border-primary/30">{{
          modpackCount }}</span>
      </RouterLink>
      <RouterLink to="/organize"
        ...
        <FolderTree class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
      ...
      <RouterLink to="/stats"
        ...
        <BarChart3 class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
      ...
      <RouterLink to="/sandbox"
        ...
        <LayoutGrid class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
      ...
      <RouterLink to="/guide"
        ...
        <BookOpen class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
    ...
    <div class="p-4 border-t border-border/50">
      <RouterLink to="/settings"
        ...
        <Settings class="w-5 h-5 transition-transform group-hover:scale-110 duration-200" />
        Settings
      </RouterLink>
    </div>
  </div>
