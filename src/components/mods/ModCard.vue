...
<template>
  <div
    class="relative rounded-xl border border-white/5 bg-[#121212] overflow-hidden group transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5"
    :class="{
