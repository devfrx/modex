...
<template>
  <div v-if="open"
    ...
    <div :class="cn(
      ...
      <div class="overflow-y-auto max-h-[calc(100vh-10rem)] sm:max-h-[calc(100vh-14rem)]">
        <slot />
      </div>
