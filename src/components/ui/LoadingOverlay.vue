  ...
  <Teleport to="body">
    ...
    >
      <div
        ...
        :class="
          fullscreen ? 'bg-background' : 'bg-background/80 backdrop-blur-sm'
        "
      >
        <div
          class="flex flex-col items-center justify-center space-y-4 p-8 rounded-xl max-w-sm text-center"
        >
          <!-- Spinner -->
          <div class="relative">
            <div
